...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasNoKey().ToTable("Cleaning_Schedule");
            ...
            {
                entity.HasNoKey().ToTable("Guest_Services");
            ...
            modelBuilder.Entity<Room>(entity =>
            {
                ...
                entity.Property(e => e.Floor).HasMaxLength(255).IsUnicode(false).HasColumnName("floor");
                entity.Property(e => e.Id).HasColumnName("id");
            ...
            {
                entity.HasNoKey().ToTable("Room_Access");

                entity.Property(e => e.AccessCardCode).HasMaxLength(50).HasColumnName("access_card_code");
                entity.Property(e => e.GuestId).HasColumnName("guest_id");
                entity.Property(e => e.Id).HasColumnName("id");
                entity.Property(e => e.RoomId).HasColumnName("room_id");
                entity.Property(e => e.Status).HasMaxLength(50).HasColumnName("status");
            ...
            {
                entity.HasNoKey().ToTable("Statistics_hotel");

                entity.Property(e => e.Adr).HasColumnType("decimal(10, 2)").HasColumnName("adr");
                entity.Property(e => e.Date).HasColumnName("date");
                entity.Property(e => e.Id).HasColumnName("id");
                entity.Property(e => e.OccupancyRate).HasColumnType("decimal(5, 2)").HasColumnName("occupancy_rate");
                entity.Property(e => e.Revenue).HasColumnType("decimal(10, 2)").HasColumnName("revenue");
                entity.Property(e => e.Revpar).HasColumnType("decimal(10, 2)").HasColumnName("revpar");
            });

            modelBuilder.Entity<Status>(entity =>
            {
                entity.HasNoKey().ToTable("Status");

                entity.Property(e => e.Id).HasColumnName("id");
                entity.Property(e => e.Name).HasMaxLength(255).IsUnicode(false).HasColumnName("name");
            });

            // Убедитесь, что модель User имеет ключ
            modelBuilder.Entity<User>(entity =>
            {
                entity.HasKey(e => e.Id); // Определение первичного ключа

                entity.Property(e => e.Id)
                      .ValueGeneratedOnAdd(); // Настройка автоинкремента
